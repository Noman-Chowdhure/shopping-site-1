...
const About = () => {
  ...
  return (
    <div className=' p-4' id='about'>
      <h1 id='topNav' className=' my-8 xl:text-6xl md:text-4xl capitalize font-light font-mono'>we make sure your product & creation deliverd porperly...</h1>
      <div className="content w-full h-fit grid grid-cols-2 md:gird-cols-1 gap-10 justify-center justify-items-center">
        ...
        <div className="text-content max-sm:col-span-2 space-y-4">
          <h1 className=' text-2xl capitalize font-safari '>why we are best platform for online..?</h1>
          ...
          <nav className=' max-sm:grid justify-center justify-items-center'>
            <ol id='ol' className=' space-y-2'>
               <li className=' border-[1px] rounded-full w-fit px-4 border-zinc-400'>we have latest colution ..</li>
               <li className=' border-[1px] rounded-full w-fit px-4 border-zinc-400'>we have latest colution ..</li>
               <li className=' border-[1px] rounded-full w-fit px-4 border-zinc-400'>we have latest colution ..</li>
               <li className=' border-[1px] rounded-full w-fit px-4 border-zinc-400'>we have latest colution ..</li>
               <li className=' border-[1px] rounded-full w-fit px-4 border-zinc-400'>we have latest colution ..</li>
